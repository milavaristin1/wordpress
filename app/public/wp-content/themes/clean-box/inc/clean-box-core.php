...
function clean_box_scripts() {
	...
	wp_enqueue_script( 'clean-box-navigation', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/navigation.min.js', array(), '20120206', true );

	wp_enqueue_script( 'clean-box-skip-link-focus-fix', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/skip-link-focus-fix.min.js', array(), '20130115', true );
	...
	if ( $options['color_scheme'] != 'light' )
		wp_enqueue_style( 'clean-box-dark', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'css/colors/'. $options['color_scheme'] .'.css', array(), null );
	 ...
	 */
	wp_register_script( 'jquery-sidr', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/jquery.sidr.min.js', array('jquery'), '2.2.1.1 - 2016-03-03', false );
	...
	if ( ! $options['disable_scrollup'] ) {
		wp_enqueue_script( 'clean-box-scrollup', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/clean-box-scrollup.min.js', array( 'jquery' ), '20072014', true  );
	}

	/**
	 * Enqueue custom script for clean-box.
	 */
	wp_enqueue_script( 'clean-box-custom-scripts', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/clean-box-custom-scripts.min.js', array( 'jquery', 'jquery-sidr' ), null );

	// Load the html5 shiv.
	wp_enqueue_script( 'clean-box-html5', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/html5.min.js', array(), '3.7.3' );
